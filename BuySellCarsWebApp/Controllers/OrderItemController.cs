...
namespace BuySellCarsWebApp.Controllers
{
    public class OrderItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
