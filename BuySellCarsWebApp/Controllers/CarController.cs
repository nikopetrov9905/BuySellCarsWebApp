...
namespace BuySellCarsWebApp.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Year,Milage,Price")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Year,Milage,Price")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
